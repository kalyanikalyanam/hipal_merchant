            ...
            if(this.state.parent_category_select=="Yes")
{
    ...
    CategoryChange  = (e) => {
        ...
        if(this.state.validError!=true){
            ...
            var ref = firebase
            .database()
            .ref('items_categories/').orderByChild("category_name").equalTo(e.target.value);
            ref.on('value', snapshot => {
            ...
            if(user_exist>0 && this.state.validError!=true){
                ...
                this.setState({category_name_message: " Category Name already exist",validError:false});
