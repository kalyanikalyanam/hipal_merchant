        ...
        <div className="menu-sidebar__content js-scrollbar1">
          <nav className="navbar-sidebar">
            <ul className="list-unstyled navbar__list">
              ...
              <li
                className={this.isPathActive("/ViewItemMenu") ? "active" : null}
              >
              ...
              <li
                className={this.isPathActive("/AllEmployees") ? "active" : null}
              >
              ...
              <li
                className={this.isPathActive("/AllMessages") ? "active" : null}
              >
