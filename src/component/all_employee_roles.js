...
class AllEmplopyesRoles extends React.Component {
    ...
    employee_userroleList=()=>{
        ...
        var ref = firebase
            .database()
            .ref("merchaant_employee_userroles/").orderByChild("sessionId").equalTo("sessionId");
        ...
        ref.on('value', snapshot => {
          ...
          businessId: childSnapShot.val().businessId,             
            ...
            this.setState({employee_userroleList: sortedKeys, countPage: data.length, loading: false});
