    ...
    return (
      <>
        <Form onSubmit={this.handleSubmit}>
                    ...
                    <div class='row mt-30'>
                      <div class='col-md-12 p-0'>
                        ...
                        <Link to='/AddCategoryMenu'>
                          <span class='btn add_categoty_menu'>
                      ...
                      <div class='row'>
                        {this.state.CategoryList &&
                          this.state.CategoryList.map((category, index) => {
                            return (
                              <div
                                class='col-md-4 mb-15 text-center'
                                key={index}
                              >
                                <div
                                onClick={this.selectParentId.bind(this, category.categoryId)}
                                // onClick={this.selectParentId(category.categoryId)}
                                  class='cate_img_box  shadow_box'
                    ...
                    <div class='row'>
                      <div class='row'>
                        {this.state.CategoryList1 &&
                          this.state.CategoryList1.map((category, index) => {
                            return (
                              <div
                                class='col-md-4 mb-15 text-center'
                                key={index}
          ...
          >
            <div
              class='modal-dialog modal-sm hipal_pop additempop'
              role='document'
            >
              <div class='modal-content'>
                <div class='modal-header'>
                  ...
                  <span class='black_font'>12 Iteams added</span>
                </div>
                    ...
                    <div class='row'>
                      ...
                      <div class='col col-md-7 bill_id_settle pl-0'>
                        <div class='form-group'>
                          ...
                          <span class='btn pull-left add_btn_pop_orange bg_green addmode_pad ml-5'>
                            Go
                          </span>
                            ...
                            <div class='col-md-6 product_box' key={index}>
                              <div class='product_box_item'>
                                ...
                                <div class='product_item_row'>
                                  <div class='left'>
                                    <span class='btn remove_btn pull-left bg_green'>
                                      Add
                                    </span>
                                  </div>
                                </div>
