    ...
    componentDidMount() {
       ...
       messageList=()=>{
        ...
        ref.on('value', snapshot => {
            ...
            this.setState({messageList: data, countPage: data.length, loading: false});
...
<div className="modal fade" id="message_chat" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
...
<button type="button" className="close chat_close" data-dismiss="modal" aria-label="Close">
...
<div className="img_cont">
    <span className="posi_rel chat_img"><img src="images/icon/profile_w.jpg" className="user_img"/><span className="online_icon"></span></span> 
    
    <span className="chat_names"><p>Rishabh Hurshan</p>
    <p>rishabh@gmail.com</p></span>
...
<div className="img_cont_msg pull-left">
    <img src="images/icon/profile.jpg" className="user_img_msg"/>
</div>
...
<div className="msg_cotainer  pull-left">
    Want to give us your email address? That way we can follow up in case we get disconnected.
...
<td><img src="images/icon/delete_cross.svg"   onClick={this.deleteItem.bind(this, message.messageId)} className="edit_delete"/></td>
</tr>
