                    ...
                    ref.on('value', snapshot => {
                        ...
                        console.log(gstData);
                            ...
                            // if(user.emailVerified==true){
                             ...
                             sessionStorage.setItem("GenerateBilling", gstData.generate_billing);
                             sessionStorage.setItem("BasicAnalytics", gstData.basic_analytics);
                             sessionStorage.setItem("PermissionType4", gstData.permission_type_4);
                             sessionStorage.setItem("ViewBillsHistory", gstData.view_bills_history);
                             sessionStorage.setItem("AddEditNewStaffAccounts", gstData.add_edit_new_staff_accounts);
                             sessionStorage.setItem("SalesView", gstData.sales_view);
                             sessionStorage.setItem("CustomerView", gstData.customer_view);
                             sessionStorage.setItem("CustomerDataEdit", gstData.customer_data_edit);
                             sessionStorage.setItem("AccessSettingsPage", gstData.access_settings_page);
                             sessionStorage.setItem("CanSettle", gstData.can_settle);
                             sessionStorage.setItem("OnlyDeliveryAssignedValues", gstData.only_delivery_assigned_values);
                             sessionStorage.setItem("CanAddItemDiscounts", gstData.can_add_item_discounts);
                             sessionStorage.setItem("StaffPerformance", gstData.staff_performance);
                             sessionStorage.setItem("DeleteKotGeneratedOfItem", gstData.delete_kot_generated_of_item);
    ...
    render() {
        ...
        return (
           ...
           type="business_id"
            ...
            {this
                                                .validator
                                                .message("Business Id", this.state.business_id, "required|min:6|max:70")}
            </div>
            </div>
            <div className="form-group">
            <div className="col-12">
         ...
         type="Password"
            ...
            <div className="btn ">Login As <a href="/">Owner</a> </div>
