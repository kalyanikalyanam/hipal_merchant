...
class EditEmployeePosition extends React.Component {
    ...
    employeePositionList=()=>{
        ...
        var ref = firebase
            .database()
            .ref(`merchaant_employees_positions/${employeePositionId}`);

            ref.on('value', snapshot => {
                var employeePosition = snapshot.val();
  ...
  <h5 className="modal-title" id="smallmodalLabel">Edit Employee Position 
  </h5>
  </div>
