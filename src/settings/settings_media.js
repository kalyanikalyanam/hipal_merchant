  ...
  stationList() {
    ...
    ref.on('value', snapshot => {
        ...
        snapshot.forEach(childSnapShot => {
            ...
            const GSTData = {
                mediaimageId: childSnapShot
                    .key
                    .toString(),
                    media_image: childSnapShot
                    .val()
                    .media_image,
                    media_video: childSnapShot
                    .val()
                    .media_video,
                    video_link: childSnapShot
                    .val()
                    .video_link,
        ...
        this.setState({MediaImageList: data, countPage: data.length, loading: false});
...
{this
                                                    .state
                                                    .MediaImageList&&this.state.MediaImageList
                                                    .map((data, index) => {
                                                        return (
...
<img src={data.media_image} id="img-upload"/>
  ...
  <div className="input-group">
       ...
       <Link to={`/SettingsEditImageMedia/${data.mediaimageId}`}>
...
<div className="upload_img upload_small small_img">
<div className="form-group">
<div className="img_show icon_small"><video className="img_show icon_small" controls   width="80%" height="80%" src={data.media_video}/></div>
{/*   
  <div className="input-group">
       <span className="input-group-btn">
           <span className="btn btn-default btn-file">
...
<span className="pull-left"><a href={data.video_link} className="form-control" target="_blank">Youtube Link</a> </span>
</div>
</div>
...
<div className="col-md-12 text-right m-t-10"><span><Link to="/SettingsAddImageMedia"><button className="save_small_button">Add Media</button></Link></span></div>
