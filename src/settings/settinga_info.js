    ...
    render() {
        return (
           ...
           placeholder="Text here" className="form-control"/>
            ...
            {this .validator.message("Easy Location Guide", this.state.easy_location_guide, "required|whitespace|min:2|max:70")}
            </div>
          ...
          value={this.state.average_price}
            ...
            {this .validator.message("Average price", this.state.average_price, "required")}
            </div>
            ...
            onChange={this.onChange} placeholder="" className="form-control"/>
            </div>
            {this .validator.message("Help Line Number", this.state.help_line_number, "required")}
            ...
            <input type="text" id="text-input" 
             name="cusine"
             onChange={this.onChange}
             value={this.state.cusine} placeholder="" className="form-control"/>
            </div>
            {this .validator.message("Cusine", this.state.cusine, "required|whitespace|min:2|max:70")}
            </div>
            
            </div>
            
            
            <div className="col-md-12 text-right m-t-10"><span><button className="save_small_button"  type="submit">Update</button></span></div>
