...
{this .validator.message("Gst Number", this.state.gst_number, "required|min:1|max:70")}
</div>
...
<FileUploader
                                                ...
                                                {this .validator.message("GstRegistrationForm", this.state.gst_registration_form, "required")}
