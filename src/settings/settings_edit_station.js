...
stationList() {
    ...
    var ref = firebase
        .database()
        .ref(`settings_station/${stationId}`);
...
<h5 className="modal-title" id="smallmodalLabel">Edit Station
</h5></div>
...
<select
                                                      className="form-control edit_product"
                                                        ...
                                                        <option>{printer_details.printer_name}</option>
...
export default SettingsEditStation;
