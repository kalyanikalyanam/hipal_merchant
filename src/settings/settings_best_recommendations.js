...
var sortedKeys = data.filter(res=>{ 
    ...
    return res.bestrecommendation == "Selected"; });
console.log(sortedKeys);
this.setState({UploadCauroselList:sortedKeys, countPage: data.length,loading: false},()=>{
...
<img src={items.item_image} id="img-upload"/>
  ...
  <div className="input-group">
       ...
       <Link to="/SettingsItemsList">   <span className="btn btn-default btn-file">
