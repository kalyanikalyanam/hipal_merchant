        ...
        <Form onSubmit={this.handleSubmit}>
          <div className="row business_reg_box">
            <div className="col-md-6">
              <div className="w-100-row open_store">
                <span></span>Open
              </div>
              ...
              <div className="row form-group mb-0">
                <div className="col-md-12">
                  <div className="timimg_row">
                    ...
                    <span className="pull-left"></span>
                    <span className="pull-left">From</span>
                    <span className="pull-left">To</span>
                    <span className="pull-left">Break</span>
                    <span className="pull-left">Between</span>
                    <span className="pull-left">To</span>
                  </div>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        id="select"
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Monday}>
                          {this.state.Monday}
                        </option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Monday_Break}>
                              {this.state.Monday_Break}
                            </option>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Tuesday}>
                          {this.state.Tuesday}
                        </option>
                        <option value="Open">Open</option>
                        <option value="Close">Close</option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Tuesday_Break}>
                              {this.state.Tuesday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Wednesday}>
                    ...
                    {this.state.Wednesday == "Open" ? (
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            name="Wednesday_Break"
                            onChange={this.onChange}
                            value={this.state.Wednesday_Break}
                            id="select"
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Wednesday_Break}>
                              {this.state.Wednesday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Thrusday}>
                          {this.state.Thrusday}
                        </option>
                        <option value="Open">Open</option>
                        <option value="Close">Close</option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Thrusday_Break}>
                              {this.state.Thrusday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Friday}>
                          {this.state.Friday}
                        </option>
                        <option value="Open">Open</option>
                        <option value="Close">Close</option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Friday_Break}>
                              {this.state.Friday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Saturday}>
                          {this.state.Saturday}
                        </option>
                        <option value="Open">Open</option>
                        <option value="Close">Close</option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Saturday_Break}>
                              {this.state.Saturday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
                  ...
                  <div className="timimg_row">
                    ...
                    <span className="pull-left">
                      <select
                        ...
                        className="form-control open_cafe"
                      >
                        <option value={this.state.Sunday}>
                          {this.state.Sunday}
                        </option>
                        <option value="Open">Open</option>
                        <option value="Close">Close</option>
                      ...
                      <>
                        ...
                        <span className="pull-left">
                          <select
                            ...
                            className="form-control open_cafe"
                          >
                            <option value={this.state.Sunday_Break}>
                              {this.state.Sunday_Break}
                            </option>
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
                          </select>
...
<input type="text" name="text-input" className="form-control"/>
            ...
            <div className="col-md-12 text-right m-t-10">
              <span>
                <button type="submit" className="save_small_button">
                  Save
                </button>
              </span>
            </div>
