                ...
                <div class="row mt-30">
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        <div class="staff_box row">
                          ...
                          <div class="col-md-5">
                            <div class="names_options">
                              <a href="#" class="active_btn">
                                <img src="/images/icon/icon_users_w.png" />
                                Customers Names
                              </a>
                            </div>
                            <div class="names_options m-t-20">
                              <a href="#">
                      ...
                      <div class="col-md-5 p-r-0">
                        <div class="user_love_box">
                          <div class="visit_row">
                            <span>
                              116<br></br>
                              <span class="sub">Visits</span>
                            </span>
                            <span>
                              Loves<br></br>
                              <span class="sub">Chicken Past</span>
                            </span>
                            <span>
                              LvL<br></br>
                          ...
                          <div class="knowmore_loves">Know more</div>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="col-12 w-100-row">
                              <div class="row">
                                ...
                                <div class="col col-md-7 bill_id_settle">
                                  Bill ID : 150315395123{" "}
                                  <span class="btn pull-right add_btn_pop_orange addmode_pad">
                                    Add mode
                                  </span>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="pay_box_block">
                                    ...
                                    <div class="box_payment">
                                      ...
                                      <p class="img">
                                        <img src="/images/icon/card_icon.png" />
                                      </p>
                                    ...
                                    <div class="box_payment">
                                      ...
                                      <p class="img">
                                        <img src="/images/icon/hipla_credits.png" />
                                      </p>
                                      <p class="price_head">Hipal Credits</p>
                                    </div>
                                    ...
                                    <div class="box_payment">
                                      ...
                                      <p class="img">
                                        <img src="/images/icon/employee_icon_pay.png" />
                                      </p>
                                    ...
                                    <div class="box_payment">
                                      ...
                                      <p class="img">
                                        <img src="/images/icon/cheqe_cion.png" />
                                      </p>
                                    ...
                                    <div class="box_payment">
                                      ...
                                      <p class="img">
                                        <img src="/images/icon/pending_icon.png" />
                                      </p>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="pay_mode_bg">
                                    ...
                                    <div class="row form-group user_roles_check">
                                      <label class="container_check">
                                        <img src="/images/icon/pnonepay.png" />
                                        <input type="checkbox" />
                                        <span class="checkmark"></span>
                                      </label>
                                    </div>
                                    ...
                                    <div class="row form-group user_roles_check">
                                      <label class="container_check">
                                        {" "}
                                        <img src="/images/icon/amezonpay.png" />
                                        <input type="checkbox" />
                                        <span class="checkmark"></span>
                                      </label>
                                    </div>
                                    ...
                                    <div class="row form-group user_roles_check">
                                      <label class="container_check">
                                        {" "}
                                        <img src="/images/icon/freecharge.png" />
                                        <input type="checkbox" />
                                        <span class="checkmark"></span>
                                      </label>
                                    </div>
                  ...
                  <div class="col-lg-5 righ_pangap cart_box_width_2">
                    <div class="btns_livecart col-md-12">
                      ...
                      <span class="width">
                        <a href="/Bill" class="btn active_item">
                          Bill
                        </a>
                      </span>
                    </div>
                        ...
                        <table width="100%">
                          <tbody>
                            ...
                            <tr>
                              ...
                              >
                                12, Sainikpuri, Kapra,<br></br> Secunderabad,
                                Telangana 500094
                              </td>
                            </tr>
