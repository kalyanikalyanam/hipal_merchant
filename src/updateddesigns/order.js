...
class Order extends React.Component {
  ...
  render() {
                  ...
                  <div className="col-lg-5 righ_pangap cart_box_width_2">
                    <div className="btns_livecart col-md-12">
                      <span className="width">
                        ...
                        <a href="/LiveCart" className="btn">
                          Live Cart
                        </a>
                      </span>
                      <span className="width">
                        <a href="/Order" className="btn active_item">
                          {" "}
                          Order
                        </a>
                      </span>
     ...
     */}
                              ...
                              <p className="cart_instu_head">
                                Instruction for the cart
                              </p>
                            </div>
    ...
    <div className="cart2_row">
    <div className="cart_head">
    <span>Cart 2 ID : 921380AJDAS213</span>
    </div>
    <div className="kot_box">
    <span className="btn kot">KOT</span>
    </div>
